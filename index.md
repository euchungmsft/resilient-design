...
분문은 [복원력 있는 애플리케이션 구현](https://docs.microsoft.com/ko-kr/dotnet/architecture/microservices/implement-resilient-applications/)을 기반으로 하여 Java 애플리케이션에 대해서 다룹니다
